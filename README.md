...
1. 从 [Releases](https://github.com/LI-S-H/translate-app/releases) 下载最新 `.msi` 安装包
2. 双击运行，安装程序会自动覆盖旧版本，**无需手动卸载**
3. 安装完成后从开始菜单或桌面快捷方式启动即可

> 更新不会影响已保存的设置（语言偏好、快捷键、API 凭据等均保留）。
